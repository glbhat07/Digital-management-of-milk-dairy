...
<html lang="en">
  ...
  <body>
  <a href="./employee.php"> <button style="float:right;margin-right:8%;margin-top:6%;" type="button" class="back-btn">
...
form.addEventListener('submit',function(e) {
   ...
   // checkEmail(email);
    ...
    if(val1==1 && val2==1 && val3 ==1 && val4==1){
        window.location.href="../auth/add.php?id="+empid.value+"&role="+role.value+"&region="+region.value+"&password="+password.value+"&empname="+empname.value;
