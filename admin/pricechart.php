...
<a href="./addprice.php"> <button style="float:right;margin-right:5%;margin-top:2%;" type="button" class="button-64">
...
$res = mysqli_query($conn,"SELECT * FROM price_chart");
...
<td>".$fetch['fat']."</td>
<td>".$fetch['price']."</td>
<td><a href=editprice.php?fat=".$fetch['fat']."&price=".$fetch['price'].">Edit</a></td>
</tr>";
}
}
else{
