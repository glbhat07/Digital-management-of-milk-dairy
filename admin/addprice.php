...
<span class="btn-label"><i class="fa fa-arrow-left"></i> </span>Back</button> </a>
 ...
 <div class="add-container">
        <form action="" method="POST" id="form" class="addform">
            ...
            <div class="form-control">
                <label for="price">Price/Ltr</label>
                <input type="" name="price" id="price" placeholder="Enter Price/Ltr">
                <small>Error Message</small>
            </div>
...
form.addEventListener('submit',function(e) {
   ...
   var val1 = checkRequired([fat,price]);
    ...
    if(val1==1){
        ...
        window.location.href="addpriceapi.php?fat="+fat.value+"&price="+price.value;
