...
<span class="btn-label"><i class="fa fa-arrow-left"></i> </span>Back</button> </a>
 ...
 <div class="add-container">
        <form action="" method="POST" id="form" class="addform">
            ...
            <div class="form-control">
                <label for="clr">Minimum CLR</label>
                <input type="" name="clr" value="<?php echo $clr;?>" id="clr" placeholder="Enter Minimum CLR">
                <small>Error Message</small>
            </div>
...
form.addEventListener('submit',function(e) {
   ...
   var val1 = checkRequired([fat,clr]);
    ...
    if(val1==1){
        ...
        window.location.href="updateclrapi.php?fat="+fat.value+"&clr="+clr.value;
